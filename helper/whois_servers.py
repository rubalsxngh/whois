'''
This code contains list of whois_servers as a dictionary.
{top_level_domain: whois_server}

refer [Whois Serverlist website](https://www.nirsoft.net/whois_servers_list.html)
'''
whois_servers = {
    "ac": "whois.nic.ac",
    "ad": "whois.ripe.net",
